<section id="our-services">
    <header class="section-header">
        <h2 class="section-title">Registrazione Istituto</h2>
        <p class="section-tagline">Per l’anno scolastico 2017-2018 FIGC e MIUR rinnovano il<br>
            loro impegno e promuovono lo sviluppo del macroprogetto<br>
            didattico e sportivo che, con una logica coerente e<br>
            progressiva, coinvolge la Scuola Primaria e quella<br>
            Secondaria di I e II grado dell’intero territorio nazionale,<br>
            integrandosi con i Campionati Studenteschi.</p>
    </header>
    <div class="container">
